...
<html lang="en">
<head>
<title>Catálogo de menús | Rápido y sabroso!</title>
...
<body> 
	...
	<div class="banner">
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="catalogo_menus.html" class="active">Catálogo de menús</a></li>
		...
		<div class="banner-text">	
			<div class="container">
				<h2>Ordena tu comida favorita <br> <span>¡desde la comodidad de tu hogar!</span></h2>
				<div class="agileits_search">
					<form action="#" method="post">
						<input name="Search" type="text" placeholder="¿Qué se te antoja comer hoy?" required="">
						<select id="agileinfo_search" name="agileinfo_search" required>
							<option value="">Categorías populares</option>
							<option value="saludable">Algo saludable</option>
							<option value="mexicana">Antojitos mexicanos</option>
							...
							<option value="mariscos">Postres</option>
						</select>
		...
		<div class="container">
		  <div class="col-md-12 product-w3ls-right"> 
				<div class="product-top">
					<h4>Catálogo de menús</h4>
					<ul> 
						<li class="dropdown head-dpdn">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtrar por categoría<span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="#">Algo saludable</a></li> 
								<li><a href="#">Antojitos mexicanos</a></li>
								<li><a href="#">Comida casera</a></li>  
								<li><a href="#">Comida extranjera</a></li>
				...
				<?php
					...
					$sql = 'SELECT idrestaurant, name, logo, category FROM restaurant';
					...
					if(!$result){
						...
						if(mysqli_num_rows($result) != 0){
							while($row = mysqli_fetch_array($result)){
								...
								echo "<div class=\"col-xs-4 col-sm-4 product-grids\">
							...
							<div class=\"flipper agile-products\">
								...
								<div class=\"back\">
								  ...
								  <form action=\"catalogo_productos.php\" method=\"post\"> 
										<input type=\"submit\" value=\"Ver el menú\" class=\"w3ls-cart pw3ls-cart\"><i class=\"fa fa-cutlery\" aria-hidden=\"true\"></i>
...
<div class="clearfix"> </div>
		  ...
		  <div class="col-md-3 rsidebar"> </div>
			<div class="clearfix"> </div> 
		</div>
	</div>
	<!-- //products --> 
