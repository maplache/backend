...
<html lang="en">
<head>
<title>Catálogo de productos | Rápido y sabroso!</title>
	...
	<div class="products">	 
		<div class="container">
		  <div class="col-md-12 product-w3ls-right"> 
				...
				$id = $_POST['id'];
				$sql = "SELECT restaurant.name, product.name, description, price FROM product, restaurant WHERE restaurant_idrestaurant = idrestaurant AND restaurant_idrestaurant = $id";
